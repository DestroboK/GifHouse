// To parse this data:
//
//   import { Convert, SearchedGIFResults } from "./file";
//
//   const searchedGIFResults = Convert.toSearchedGIFResults(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchedGIFResults {
    data:       Gif[];
...
export class Convert {
    public static toSearchedGIFResults(json: string): SearchedGIFResults {
        return cast(JSON.parse(json), r("SearchedGIFResults"));
    }

    public static searchedGIFResultsToJson(value: SearchedGIFResults): string {
        return JSON.stringify(uncast(value, r("SearchedGIFResults")), null, 2);
    }
}
